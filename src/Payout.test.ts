...
describe('Payout ZkApp Tests', () => {
  ...
  it('Deploy and initialize Payout zkApp', async () => {
    await localDeploy(zkapp, aliceKey, zkappPrivateKey);
  });
...
async function requestPayout(
  ...
  await requestTx.prove();
  console.log('Request counts:', logTxCounts(requestTx), 'request');
...
async function sendPayout(
  ...
  console.log('Payout counts:', logTxCounts(payoutTx));
